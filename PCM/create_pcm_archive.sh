...
#credit to ebastler and MarvFPV for the this which was in their marbastlib repo.
...
echo DOWNLOAD_URL="https:\/\/github.com\/$GITHUB_REPOSITORY\/download\/$VERSION\/KiCAD-PCM-$VERSION.zip" >> $GITHUB_ENV
